# ES futures data probe for the LEAN migration. This is an INFRASTRUCTURE CHECK, not a
# strategy: it places no orders and expresses no hypothesis about the market.
#
...
class F2EsTickProbeAlgorithm(QCAlgorithm):
